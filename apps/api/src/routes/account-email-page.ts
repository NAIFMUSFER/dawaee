...
(function () {
  ...
  const labels = en ? {
    ...
    verified: 'Your email is verified. Return to TADAWEE.', registered: 'Your account is ready. Sign in with the same email. Invitations sent to that email appear on Today for you to review and accept.',
    signIn: 'Sign in to TADAWEE', registerExpiry: 'This account-creation link expires after 30 minutes.',
    ...
    registered: 'تم إنشاء حسابك. سجّل الدخول بالبريد نفسه؛ تظهر الدعوات المرسلة لهذا البريد في صفحة اليوم لمراجعتها وقبولها.',
    signIn: 'تسجيل الدخول إلى تداوي', registerExpiry: 'رابط إنشاء الحساب صالح لمدة 30 دقيقة.',
  ...
  document.getElementById('expiry').textContent = purpose === 'register' ? labels.registerExpiry : labels.expiry;
  continueLink.textContent = labels.signIn;
