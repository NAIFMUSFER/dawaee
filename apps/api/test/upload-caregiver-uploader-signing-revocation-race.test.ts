...
const IMAGE_KEY = 'synthetic-caregiver-uploader-signing-revocation/prescription.jpg';
let h: Harness;
let db: pg.Pool;
...
beforeAll(async () => {
  ...
  patient = await signIn(h, '+966500096868');
  caregiver = await signIn(h, '+966500096869');
