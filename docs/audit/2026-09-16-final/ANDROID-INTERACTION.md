...
المتابعة التالية `dose_check.py` تنشئ حسابين ودواءً اصطناعيًا مستحقًا حسب ساعة الخادم، مع المخزون وبدونه. التأكيد والتراجع والتأكيد الثاني تتم بأزرار Android حصريًا؛ API يجهز البيانات ويقرأ الحالة والمخزون فقط. يُختبر إغلاق العملية وفتحها ثانية والسجل، مع رصيد60→54→60→54 وحركات-6,+6,-6 دون تكرار. لا يدخل أي معرّف حساب أو رمز في ملفات الأدلة. النتيجة **NOT VERIFIED** حتى اكتمال التشغيل الموثق فيPR30.
