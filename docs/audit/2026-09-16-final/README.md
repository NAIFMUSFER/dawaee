...
- [نسيت كلمة المرور: الإصلاح والعقد والترحيل0084 وحدود القناة](PASSWORD-RECOVERY.md)
- [متابعة17سبتمبر: فتح المعاينة وتفاعل Android والصور بعد الإصلاح](ANDROID-INTERACTION.md)؛ تحدّث النتائج الأولية أدناه، ولا تعني اختبار هاتف فعلي.
- [متابعة التدقيق: حدود تركيز OCR وسبب فشل pre-deploy المثبت](FOLLOW-UP.md)
